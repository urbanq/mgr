...
CREATE TEMPORARY TABLE JGP_PARAMETER_TMP(
    ...
    INCOME_MODE_LIMIT INT,          -- Kod ograniczenia dla trybu przyjęcia
    OUTCOME_MODE_LIMIT INT,         -- Kod ograniczenia dla trybu wypisu
...
CREATE TABLE JGP_PARAMETER(
    ...
    LIMIT_SEX CHAR(1),
    INCOME_MODE_LIMIT INT,
    OUTCOME_MODE_LIMIT INT,
    ...
    FOREIGN KEY(INCOME_MODE_LIMIT) REFERENCES INCOME_MODE_LIMIT(ID),
    FOREIGN KEY(OUTCOME_MODE_LIMIT) REFERENCES OUTCOME_MODE_LIMIT(ID),
