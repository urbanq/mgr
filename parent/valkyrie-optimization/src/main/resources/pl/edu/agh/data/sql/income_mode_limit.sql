...
CREATE TABLE INCOME_MODE_LIMIT(
    ...
    NAME VARCHAR(100) NOT NULL -- nazwa trybu przyjecia
);
------------------------------------------------------------------------------------------------------------------------
...
INSERT INTO INCOME_MODE_LIMIT (ID, NAME) VALUES (5, 'Przyjęcie planowe osoby, która skorzystała ze świadczeń opieki zdrowotnej poza kolejnością');
